...
const DATA = {
  ...
  section2: {
    ...
    subheadings: [
      ...
      'Whether you\'re running a Canton node, need operational data across public chains, or need to share data with an auditor or regulator, Noves routes the right data to the right people.',
    ],
    privateDataOptions: [
    ...
    sentinelOptions: [
      { id: 0, label: 'The sentinel',            explanation: 'Explanation TBD.' },
      { id: 1, label: 'Controlled access layer', explanation: 'Explanation TBD.' },
      { id: 2, label: 'The governance layer',    explanation: 'Explanation TBD.' },
      { id: 3, label: 'Governed access',         explanation: 'Maps to regulatory language (MiCA, FCA PS21/3, SOC 2, Basel III) — the institutional buyer already speaks this language. Controlled access is more technical and literal.' },
    ],
  },
  ...
  section3: {
    ...
    subheadings: [
      'For regulated institutions, this means meeting supervisory expectations for traceability and control without adding new friction or bureaucracy.',
